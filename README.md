...
- `/tmux` uses tmux's live current client pane/path for grouping, so the pane/session you're actually working in is treated as current even if the pi process started elsewhere.
